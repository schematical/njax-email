...
module.exports = function(options){
    ...
    njax_app._registerEmail = function(event, options){
		...
		var populateAdditionalUsers = (options.populateAdditionalUsers/* && _.isFunction(options.populateAdditionalUsers)*/) || function(accounts, event, options, cb){ return cb(null, accounts); };
